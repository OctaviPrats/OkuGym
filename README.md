<div align="center">
> **📦 Initial OkuGym import.** This repository starts from the original upstream codebase by Duarte Santos and has been rebranded as **OkuGym** for the `OctaviPrats/OkuGym` project. See [NOTICE.md](NOTICE.md).


<img src="assets/banner.svg" alt="OkuGym" width="720">
...
<br>
![GitHub last commit](https://img.shields.io/github/last-commit/OctaviPrats/OkuGym?style=flat-square)
[![GitHub stars](https://img.shields.io/github/stars/OctaviPrats/OkuGym?style=flat-square)](https://github.com/OctaviPrats/OkuGym/stargazers)
[![GitHub issues](https://img.shields.io/github/issues/OctaviPrats/OkuGym?style=flat-square)](https://github.com/OctaviPrats/OkuGym/issues)
...
### [🐙 github.com/OctaviPrats/OkuGym](https://github.com/OctaviPrats/OkuGym)

Freshly imported and renamed for the OkuGym project.<br>
<sub>Build and release artifacts can be added on top of this baseline as the project evolves.</sub>
...
disappear when the startup does. OkuGym is the opposite: **it runs on your box, your data
...
```bash
git clone https://github.com/OctaviPrats/OkuGym
cd OkuGym
cp .env.example .env
...
- **Android:** build the APK yourself with **[docs/MOBILE.md](docs/MOBILE.md)** —
  OkuGym is deliberately not on the Play Store.
...
| `RP_NAME`     | Name shown in the passkey prompt                     | `OkuGym`               |
...
- [x] Standalone mobile app — Android APK build support; on iOS as a self-hosted PWA (no store listings planned)
...
- **[Q&A](https://github.com/OctaviPrats/OkuGym/discussions/categories/q-a)** — self-hosting
  help, passkey/login trouble, "how do I…". Most login problems turn out to be an `RP_ID`/`ORIGIN`
  mismatch.
- **[Ideas](https://github.com/OctaviPrats/OkuGym/discussions/categories/ideas)** — features
  worth talking through before anyone writes code.
- **[Show and tell](https://github.com/OctaviPrats/OkuGym/discussions/categories/show-and-tell)**
  — your setup, your plan templates, whatever you built on top.
- **[Issues](https://github.com/OctaviPrats/OkuGym/issues)** — bugs, and work that's already
  been agreed on.
...
OkuGym is free and stays free: AGPL, no subscription, no paid tier, nothing held back for
...
the same license. Nobody can turn OkuGym into a closed, proprietary product.

...
export const DEF = {
  ...
  theme: 'dark', accent: 'lime', body: 'male', targetW: null, targetBF: null,
  bodyweight: [], bodyComp: [], routines: [], week: {}, dayPlan: {},
...
const hasData = st => !!((st.workouts || []).length || (st.routines || []).length || (st.bodyweight || []).length || (st.bodyComp || []).length)

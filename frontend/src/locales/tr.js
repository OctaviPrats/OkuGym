...
export default {
  ...
  "This browser doesn't support passkeys — you can still use OkuGym locally on this device.": 'Bu tarayıcı geçiş anahtarlarını desteklemiyor — yine de OkuGym’i bu cihazda yerel olarak kullanabilirsin.',
  ...
  'to install OkuGym as a full-screen app.': 'ile OkuGym’i tam ekran uygulama olarak kurabilirsin.',
  ...
  'Rest-timer alerts, even if OkuGym is closed.': 'OkuGym kapalıyken bile dinlenme sayacı uyarıları.',
  ...
  'A small file a friend imports into their own OkuGym — routines only, none of your workouts or weigh-ins.': 'Bir arkadaşının kendi OkuGym\'ine aktardığı küçük bir dosya — yalnızca rutinler, antrenmanların veya tartıların değil.',

...
export default {
  ...
  'Log body fat': 'Registrar grasa corporal',
  'Recent body fat entries': 'Registros recientes de grasa corporal',
  'Enter a valid body fat percentage': 'Introduce un porcentaje de grasa válido',
  'Body fat saved': 'Grasa corporal guardada',
  'Target body fat': 'Grasa corporal objetivo',
  'Your goal is drawn as a line through the body-fat charts, and changes are colored by whether they move toward it.': 'Tu objetivo se dibuja como una línea en las gráficas de grasa corporal, y los cambios se colorean según se acerquen a él.',
  'No body-fat entries yet — log one to start the curve.': 'Sin registros de grasa corporal aún — apunta uno para empezar la curva.',
  'Body fat 30d': 'Grasa corporal 30d',
  'reached!': '¡conseguido!',
  ...
  "This browser doesn't support passkeys — you can still use OkuGym locally on this device.": 'Este navegador no admite passkeys — aun así puedes usar OkuGym localmente en este dispositivo.',
  ...
  'to install OkuGym as a full-screen app.': 'para instalar OkuGym como app a pantalla completa.',
  ...
  'Rest-timer alerts, even if OkuGym is closed.': 'Avisos del temporizador de descanso, incluso con OkuGym cerrado.',
  ...
  'A small file a friend imports into their own OkuGym — routines only, none of your workouts or weigh-ins.': 'Un archivo pequeño que un amigo importa en su propio OkuGym: solo rutinas, ninguno de tus entrenamientos ni pesajes.',

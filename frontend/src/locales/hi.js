...
export default {
  ...
  "This browser doesn't support passkeys — you can still use OkuGym locally on this device.": 'यह ब्राउज़र पासकी सपोर्ट नहीं करता — फिर भी आप इस डिवाइस पर OkuGym लोकली इस्तेमाल कर सकते हैं।',
  ...
  'to install OkuGym as a full-screen app.': 'से OkuGym को फुल-स्क्रीन ऐप के रूप में इंस्टॉल करें।',
  ...
  'Rest-timer alerts, even if OkuGym is closed.': 'आराम टाइमर अलर्ट, OkuGym बंद होने पर भी।',
  ...
  'A small file a friend imports into their own OkuGym — routines only, none of your workouts or weigh-ins.': 'एक छोटी फ़ाइल जिसे कोई दोस्त अपने OkuGym में आयात कर सके — सिर्फ़ रूटीन, आपके वर्कआउट या वज़न नहीं।',
  ...
  'Reload OkuGym': 'OkuGym फिर से लोड करें',

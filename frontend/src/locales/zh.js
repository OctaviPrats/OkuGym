...
export default {
  ...
  "This browser doesn't support passkeys — you can still use OkuGym locally on this device.": '此浏览器不支持通行密钥——你仍可在本设备上本地使用 OkuGym。',
  ...
  'to install OkuGym as a full-screen app.': '即可将 OkuGym 安装为全屏应用。',
  ...
  'Rest-timer alerts, even if OkuGym is closed.': '休息计时提醒，即使 OkuGym 已关闭。',
  ...
  'A small file a friend imports into their own OkuGym — routines only, none of your workouts or weigh-ins.': '一个小文件，朋友可以导入到自己的 OkuGym——只有训练日，不包含你的训练记录或体重。',

...
export default {
  ...
  "This browser doesn't support passkeys — you can still use OkuGym locally on this device.": 'Этот браузер не поддерживает ключи доступа — но OkuGym можно использовать локально на этом устройстве.',
  ...
  'to install OkuGym as a full-screen app.': 'чтобы установить OkuGym как полноэкранное приложение.',
  ...
  'Rest-timer alerts, even if OkuGym is closed.': 'Оповещения таймера отдыха, даже если OkuGym закрыт.',
  ...
  'A small file a friend imports into their own OkuGym — routines only, none of your workouts or weigh-ins.': 'Небольшой файл, который друг импортирует в свой OkuGym — только программы, без твоих тренировок и взвешиваний.',
  ...
  'Reload OkuGym': 'Перезагрузить OkuGym',
